...
# Mapea nombres de script (clave pública) a la ruta relativa del script real.
# Añade aquí nuevas automatizaciones cuando las implementes.
...
"area_privada": "src/scripts/area_privada.py",
}